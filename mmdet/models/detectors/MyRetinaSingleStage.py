...
class MyRetinaSingleStageDetector(MyRetinaBase):
    ...
    def forward_train(self, img, img_metas, gt_bboxes, gt_labels, gt_bboxes_ignore=None, **kwargs):
        super(MyRetinaSingleStageDetector, self).forward_train(img, img_metas)
