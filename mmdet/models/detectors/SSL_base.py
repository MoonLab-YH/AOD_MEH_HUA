...
class SSLBaseDetector(BaseModule, metaclass=ABCMeta):
    """Base class for detectors."""

    def __init__(self, init_cfg=None):
        super(SSLBaseDetector, self).__init__(init_cfg)
    ...
    def forward(self, img, img_metas, return_loss=True, **kwargs):
        ...
        if return_loss:
            ...
            return self.forward_test(img, img_metas, **kwargs, _data=img[0])
