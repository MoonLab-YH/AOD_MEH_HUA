...
class SSD_Ens_SingleStageDetector(SSLBase_L_Detector):
    ...
    def forward_train(self, img, img_metas, gt_bboxes, gt_labels, gt_bboxes_ignore=None, **kwargs):
        super(SSD_Ens_SingleStageDetector, self).forward_train(img, img_metas)
