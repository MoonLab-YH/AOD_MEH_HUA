...
class EDLSoftSelfWRetinaHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(EDLSoftSelfWRetinaHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def _get_bboxes(self,
        ...
        for cls_score, bbox_pred, anchors in zip(mlvl_cls_scores, mlvl_bbox_preds,
                                                 mlvl_anchors):
        ...
        if kwargs['isUnc']:
            uncertainties = []
            for Score, Alpha in zip(batch_mlvl_scores, batch_mlvl_alphas):# TODO wrong code, do not use bboxes!!
                if with_nms:
                ...
                if kwargs['isUnc'] == 'Shannon':
                    ...
                    uncertainties.append(epistemic * score_max) # Uncertainty Re-weighting
