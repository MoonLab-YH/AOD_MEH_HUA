...
class EDLSoftSLRetinaHead(AnchorHead):
    ...
    def __init__(self,
        ...
        self.k = k
        super(EDLSoftSLRetinaHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def _get_bboxes(self,
        ...
        for cls_score, bbox_pred, anchors in zip(mlvl_cls_scores,
            ...
            if self.last_activation == 'relu':
                _prob = cls_score.softmax(dim=1)
                alphas = self.k * _prob + 1
        ...
        # bbox_results = [bbox2result(det_bboxes, det_labels, 20)for det_bboxes, det_labels in det_results]
