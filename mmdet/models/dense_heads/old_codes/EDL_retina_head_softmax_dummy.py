...
class EDLSoftRetinaHead_Dummy(AnchorHead):
    ...
    def __init__(self,
        ...
        super(EDLSoftRetinaHead_Dummy, self).__init__(
            num_classes,
            in_channels,
    ...
    def _init_layers(self):
        ...
        self.retina_cls = nn.Conv2d(
            self.feat_channels,
            self.num_anchors * (self.cls_out_channels + self.dummy_classes),
            3,
            padding=1)
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
        ...
        cls_score = cls_score.permute(0, 2, 3, 1).reshape(-1, self.cls_out_channels + self.dummy_classes)
    ...
    def _get_bboxes(self,
        ...
        for cls_score, bbox_pred, anchors in zip(mlvl_cls_scores,
            ...
            cls_score = cls_score.permute(0, 2, 3,1).reshape(batch_size, -1,
                                                              self.cls_out_channels + self.dummy_classes)
