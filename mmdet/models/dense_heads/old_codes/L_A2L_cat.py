...
class A2LcatNet(L_AnchorHead):
    def __init__(self,
        ...
        super(A2LcatNet, self).__init__(num_classes, in_channels,
                                        anchor_generator=anchor_generator, init_cfg=init_cfg, **kwargs)
    ...
    def forward_single_L(self, x, cls_score):
        L_feat = torch.cat((x,cls_score.detach()), dim=1)
