...
class D_AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
        ...
        super(D_AnchorHead, self).__init__(init_cfg)
    ...
    def loss(self, cls_scores, bbox_preds, D_scores, gt_bboxes, gt_labels, img_metas, gt_bboxes_ignore=None, **kwargs):
        ...
        loss_input = (cls_scores, bbox_preds, all_anchor_list, labels_list, label_weights_list
        ...
        return dict(loss_cls=losses_cls, loss_bbox=losses_bbox), loss_input

    @force_fp32(apply_to=('D_scores'))
    def loss_D(self, D_scores, **kwargs):
        label_weights_list = kwargs['head_out'][4]
        losses_D, _ = multi_apply(self.loss_single_D, D_scores, label_weights_list, **kwargs)
        return dict(loss_D=losses_D)
